                            ...
                            if choice_acme == 'y':
                                while True:
                                    ...
                                    if dns_name == '1':
                                        ...
                                        dns_token = input("Please enter Gandi.net's api_token:")
                                        ...
                                        dns_token = input("Please enter Name.com's namedotcom_token:")
                                        dns_user = input("Please enter Name.com's namedotcom_user:")
                                        namedotcom_server = input("Please enter Name.com's namedotcom_server:")
